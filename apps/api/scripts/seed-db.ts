...
async function main(): Promise<void> {
  ...
  process.stdout.write("\n");
  process.stdout.write(`Company:   ${COMPANY.name} — HQ ${COMPANY.headquartersLocation}\n`);
  process.stdout.write(`Jobs:      ${JOBS.length} published, all Philippine-based, monthly PHP salaries\n`);
