...
3. 1-6 evidence excerpts in total — a mix of positive (what helped) and negative (what was missing or mismatched).
   ...
   - contribution_points: integer. Positive when the quote helped (+N). Negative when it represents a gap (-N). 0 only for purely neutral context.
...
- The negative items' contribution_points should sum approximately to (score - max). They explain the deficit numerically, not just narratively.
