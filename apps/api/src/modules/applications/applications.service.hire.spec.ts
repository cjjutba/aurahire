...
function makeOffersMock() {
  return { findLatestByApplicationId: jest.fn() };
}
    ...
    const mod: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: AuditService, useValue: { log: jest.fn() } },
        {
          ...
          useValue: { bustTags: jest.fn().mockResolvedValue(undefined) },
        },
        {
          provide: EventsService,
          useValue: { emitApplicationStatusChanged: jest.fn() },
        },
        ...
        { provide: MatchScoreQueueService, useValue: { enqueue: jest.fn() } },
        {
          ...
          useValue: {
            ...
            findCandidateProfile: jest.fn().mockResolvedValue(null),
          },
        },
