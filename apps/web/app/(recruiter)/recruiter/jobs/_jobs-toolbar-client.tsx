...
export function JobsToolbar({
  ...
  const currentStatus =
    STATUS_OPTIONS.find((o) => o.value === initialStatus) ?? STATUS_OPTIONS[0]!;
  const currentMode =
    MODE_OPTIONS.find((o) => o.value === initialMode) ?? MODE_OPTIONS[0]!;
  const currentExp =
    EXPERIENCE_OPTIONS.find((o) => o.value === initialExperience) ??
    EXPERIENCE_OPTIONS[0]!;
  const currentSort =
    SORT_OPTIONS.find((o) => o.value === initialSort) ?? SORT_OPTIONS[0]!;
