  ...
  return (
    <div className="mx-auto max-w-[1280px] space-y-6">
      ...
      <div className="overflow-hidden rounded-[var(--radius-lg)] border border-[var(--color-hairline)] bg-[var(--color-canvas)]">
        {/* Table header band */}
        <div className="grid grid-cols-[2fr_1.5fr_1fr_0.8fr_1fr_1fr_40px] gap-4 border-b border-[var(--color-hairline)] bg-[var(--color-surface-soft)] px-4 py-3">
        ...
        <div className="divide-y divide-[var(--color-hairline-soft)]">
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              className="grid grid-cols-[2fr_1.5fr_1fr_0.8fr_1fr_1fr_40px] items-center gap-4 px-4 py-3"
            >
