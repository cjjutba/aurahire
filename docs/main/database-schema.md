...
The seed creates: default `scoring_config` row, then prints instructions for the human to register an admin user via the running app and manually `UPDATE profiles SET role='admin' WHERE email = 'admin@aurahire.site'`.
